...
<%@page import="in.co.college.att.mgt.controller.FacultyCtl"%>
...
<form style="width: 60%;margin-top: 25px" action="<%=CASView.FACULTY_CTL%>" method="post">
...
<input type="hidden" name="id" value="<%=bean.getId()%>"> <input
  ...
  <div class="form-row">
    ...
    <input type="submit" name="operation" class="btn btn-primary"
					value="<%=FacultyCtl.OP_SAVE%>"> or <input type="submit" name="operation" class="btn btn-primary"
