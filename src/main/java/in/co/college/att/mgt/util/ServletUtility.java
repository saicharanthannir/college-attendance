...
import in.co.college.att.mgt.controller.BaseCtl;
import in.co.college.att.mgt.controller.CASView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(CASView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
